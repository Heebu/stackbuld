...
class TransactionHistoryViewmodel extends StatelessWidget {
  const TransactionHistoryViewmodel({super.key});
          ...
          child: viewModel.completeTransaction.isEmpty
              ...
              : ListView.separated(
                  itemBuilder: (context, index) {
                    final transactions = viewModel.allTransaction[index];
                    final itemDetails = [];
